 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [SourceCodePro.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/SourceCodePro.zip)
   * [SourceCodePro.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/SourceCodePro.tar.xz) (smaller)
